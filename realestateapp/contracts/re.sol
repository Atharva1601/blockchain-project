...
contract Realstate {
    ...
    //STATE VARIABLE 
    struct Property{ uint256 productID; 
    address owner; 
    uint256 price; 
    ...
    // REVIEWSECION 
    struct Review{ address reviewer; uint256 productId; uint256 rating; string comment; uint256 likes; } 
    struct Product{ uint256 productId; uint256 totalRating; uint256 numReviews;}

    //MAPPING 
    mapping (uint256 => Property) private properties; uint256 public propertyIndex; 
    mapping(uint256 => Review[]) private reviews; 
    mapping (address => uint256[]) private userReviews;
    mapping(uint256 => Product) private products; uint256 public reviewsCounter;
    ...
    function listProperty(address owner, uint256 price, string memory _propertyTitle, string memory _category, string memory _images, string memory _propertyAddress, string memory _description) external returns (uint256){
        ...
        property.category = _category; property.images = _images; 
    ...
    { Property storage property = properties [productId]; 
    require(property.owner == owner, "Your are not the owner"); 
    property.price = price; return "Your Property price is updated"; }
